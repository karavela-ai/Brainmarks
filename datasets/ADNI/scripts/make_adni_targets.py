...
# CSV is generated by adni_curation.py; override with ADNI_CSV_PATH env var if needed
ADNI_CSV_PATH = Path(os.environ.get("ADNI_CSV_PATH", str(ROOT / "metadata/adni_fmri_benchmark_split.csv")))
